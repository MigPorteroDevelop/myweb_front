...
const projects = [
  {
    ...
    imageAlt: "dream-guitar",
    web: "https://silly-druid-8f86ca.netlify.app/",
    github: "https://github.com/MigPorteroDevelop/Guitar-Ecommerce",
    category: [1],
  },
  {
    id: 2,
        ...
        <div v-for="project in showedProjects" :key="project.id" class="col-span-1">
          <div class="shadow-xl p-2">
            ...
            <div class="flex items-center justify-between mt-4">
              <div>
                <h3 class="text-md font-serif text-gray-700 italic">
                  <span aria-hidden="true"></span>
                  {{ project.name }}
                </h3>
              </div>
              <div class="flex">
                <div class="links cursor-pointer p-1">
                  <a :href="project.web" target="_blank">
                    <svg fill="#000000" class="h-9 w-9 link-icon" viewBox="0 0 30 30"
                ...
                <div class="links cursor-pointer p-1">
                  <a :href="project.github" rel="noreferrer" target="_blank">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 link-icon" viewBox="0 0 50 50"
                      style="fill:#1A1A1A;">
                      <path
