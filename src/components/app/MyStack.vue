        ...
        <div class="flex flex-wrap justify-center items-center space-y-5 sm:space-y-0 sm:space-x-10 px-12 sm:h-fit">
            <div
                ...
                <div class="flex flex-col items-center py-10 ">
                    <svg class="w-24 h-24 mb-3 bg-white rounded-full shadow-lg" width="256" height="154"
            ...
            <div
                ...
                <div class="flex flex-col items-center py-10">
                    <svg class="w-24 h-24 mb-3 bg-white rounded-full shadow-lg" height="154" preserveAspectRatio="xMidYMid"
